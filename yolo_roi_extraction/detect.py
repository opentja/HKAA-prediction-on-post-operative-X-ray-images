...
def detect(save_txt=True, save_img=False):
    ...
    weights = opt.weights + '/weights/batchSize'+str(opt.batchSize)+'Epochs'+str(opt.epochs)+'LR'+str(opt.lr)+'-1best.pt'
    source = opt.source +  '/inputImages/'
    out = opt.output + '/outputImagesAndTxt/'
    half, view_img = opt.half, opt.view_img
...
if __name__ == '__main__':
    ...
    parser.add_argument('--epochs', default=128)
